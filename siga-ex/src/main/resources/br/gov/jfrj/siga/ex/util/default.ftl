	...
	<table style="float:none; clear:both;" width="100%" align="left" border="0" cellpadding="0"
	    ...
	    <tr bgcolor="#FFFFFF">
	        ...
	        <table width="100%" border="0" cellpadding="2">
	            <tr>
	                <td width="100%" align="center" valign="bottom"><img src="${_pathBrasao}" width="${func.resource('/siga.brasao.width')}" height="${func.resource('/siga.brasao.height')}" /></td>
	            </tr>
	            <tr>
    ...
    [@entrevista]
        ...
        [/#if]
            [@grupo titulo="Dados do destinatário" esconder=(_enderecamento_dest!="" && _nome_dest!="" && _cargo_dest!="" && _orgao_dest!="" && _endereco_dest!="")]
                <!-- Tratamento -->
                [#if doc.exModelo.nmMod == "Ofício Externo"]
